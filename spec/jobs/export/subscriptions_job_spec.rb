...
describe Export::SubscriptionsJob do
  ...
  subject { Export::SubscriptionsJob.new(format, mailing_list.id, true, 'subscription_export') }
  ...
  let(:filepath)     { AsyncDownload::DOWNLOAD_DIRECTORY.join('subscription_export') }
